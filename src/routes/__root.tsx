  ...
  head: () => ({
    meta: [
      ...
      { title: "Himalyan Wheels — Used Cars in Solan, Himachal Pradesh" },
      {
        name: "description",
        content:
          "Buy, sell or exchange quality pre-owned cars in Solan, Himachal Pradesh. Transparent deals, finance assistance and WhatsApp support from Himalyan Wheels.",
      },
      { name: "author", content: "Himalyan Wheels" },
